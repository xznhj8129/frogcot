...
class Event(BaseModel):
    ...
    class Detail(BaseModel):
        ...
        :ivar usericon: The attribute, iconsetpath, that references any
            installed iconset should be the path into the set to the raw
            icon file. For instance, the google hiker icon:
            "f7f71666-8b28-4b57-9fbb-e38e61d33b79/Google/hiker.png". The
            first path element is the UID of the iconset.
        """
